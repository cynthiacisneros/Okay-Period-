  ...
  var PRODUCTS = [
    {
      ...
      description: "A simple, low-cost option that can help you get started without overthinking it. These pads can be found at your local Dollar Tree store, and cost $1.25 per pack.",
    ...
    },
    {
      ...
      category: "Pads",
      priceTier: "Affordable",
      description: "If you have access to a H-E-B store, these pads can be found there, and are a great option for beginners.",
      tags: ["Budget", "Beginner Friendly"],
