...
(function () {
  ...
  var PRODUCTS = [
    ...
    },
    {
      ...
      category: "Pads",
      priceTier: "Mid-range",
      description: "A good option if your flow feels heavier, especially at night when you want extra coverage.",
    ...
    },
    {
      ...
      category: "Pads",
      priceTier: "Mid-range",
      description: "A softer-feeling option that can be more comfortable for sensitive skin.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      category: "Pads",
      priceTier: "Mid-range",
      description: "Some people like these for how they feel—everyone’s body is different, so it’s okay to try and see.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      description: "Made with organic cotton and designed to feel a little more gentle and breathable.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      category: "Pads",
      priceTier: "Higher-end",
      description: "A clean, simple option if you’re looking for something with fewer added materials.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      category: "Tampons",
      priceTier: "Mid-range",
      description: "A popular choice with a smooth applicator that can feel easier to use at first.",
    ...
    },
    {
      ...
      category: "Tampons",
      priceTier: "Mid-range",
      description: "An organic cotton option if you prefer something more natural.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      category: "Tampons",
      priceTier: "Mid-range",
      description: "A simple, widely available option that many people feel comfortable using.",
      tags: ["Organic Cotton"],
    ...
    },
    {
      ...
      priceTier: "Higher-end",
      description: "Feels like regular underwear, but designed to absorb your flow—some people love this as a low-stress option.",
